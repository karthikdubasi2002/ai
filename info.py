...
USERNAME = environ.get('USERNAME', "https://telegram.me/mr_krazy")
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001652564383'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/theheroflix')
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1001652564383'))
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1001652564383'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002475476848'))
URL = environ.get('URL', 'healthy-bobby-oqajpth65-be4720c5.koyeb.app')
STICKERS_IDS = ('CAACAgQAAxkBAAEK99dlfC7LDqnuwtGRkIoacot_dGC4zQACbg8AAuHqsVDaMQeY6CcRojME').split()
FILE_AUTO_DEL_TIMER = int(environ.get('FILE_AUTO_DEL_TIMER', '600'))
IS_VERIFY = is_enabled('IS_VERIFY', False)
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1001652564383'))
...
UPI_PAY_LOGS = int(environ.get('UPI_PAY_LOGS', '-1001652564383'))
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1001521700370'))
...
FILE_CAPTION = environ.get('FILE_CAPTION', f'{script.FILE_NAME}')
